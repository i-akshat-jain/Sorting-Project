...
algMenu = ttk.Combobox(UI_frame, textvariable=selected_alg, 
        values=['Bubble Sort', 'Intserion Sort','Selection Sort','Merge Sort', 'Quick Sort'])
algMenu.grid(row=0, column=1, padx=5, pady=5)
algMenu.current(0)

speedScale = Scale(UI_frame, from_ = 0.01, to =1 , length =200, digits = 2, resolution = 0.2 , orient = HORIZONTAL, label = "Select Speed [s] ")
